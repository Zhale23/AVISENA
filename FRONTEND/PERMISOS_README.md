...
1. **index1.html** - Script inline al final que oculta opciones del menú
...
2. Al cargar index1.html → Script lee el rol y oculta items del menú con `display: none`
...
En el script de index1.html, agregar el módulo a los arrays:
